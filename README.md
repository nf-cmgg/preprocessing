# ![CenterForMedicalGeneticsGhent/nf-cmgg-preprocessing](docs/images/nf-core-cmgg-preprocessing_logo_light.png#gh-light-mode-only) ![CenterForMedicalGeneticsGhent/nf-cmgg-preprocessing](docs/images/nf-core-cmgg-preprocessing_logo_dark.png#gh-dark-mode-only)
...
The CenterForMedicalGeneticsGhent/nf-cmgg-preprocessing pipeline comes with documentation about the pipeline [usage](https://nf-co.re/cmgg-preprocessing/usage), [parameters](https://nf-co.re/cmgg-preprocessing/parameters) and [output](https://nf-co.re/cmgg-preprocessing/output).
