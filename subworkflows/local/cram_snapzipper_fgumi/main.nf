...
// MODULES
include { FGUMI_SNAPALIGN                               } from "../../../modules/local/fgumi/snapalign/main.nf"
include { FGUMI_ZIPPER                                  } from "../../../modules/nf-core/fgumi/zipper/main.nf"
...
workflow CRAM_SNAPZIPPER_FGUMI {
    ...
    SAMTOOLS_QNAME_SORT_MAPPED(
        FGUMI_SNAPALIGN.out.mapped_bam
            .join(
    ...
    versions_fgumi = FGUMI_SNAPALIGN.out.versions_fgumi.mix(FGUMI_ZIPPER.out.versions_fgumi).mix(FGUMI_TEMPLATE_SORT.out.versions_fgumi)
}